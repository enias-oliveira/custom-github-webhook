defmodule CaseSwap do
  ...
  defp get_repository_resource(repository_full_name, resource_name) do
    fetch_resource_page = fn page_number -> Github.fetch_repository_resource(repository_full_name, resource_name, page_number) end
  ...
  defp get_repository_resource_by_user(repository_full_name, resource_name, username) do
    fetch_resource_page = fn page_number -> Github.fetch_repository_resource_by_user(repository_full_name, resource_name, page_number, username) end
    get_resource_recursion_aux(fetch_resource_page, [], 1)
  end
end
